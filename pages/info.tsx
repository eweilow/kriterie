export default () => (
  <>
    ...
    <p>
      ...
      relevanta informationen om gymnasiets kurser, ämnen och program, men även
      också funktionalitet som underlättar studietiden både för elever och
      lärare.
    </p>
    ...
    <p>
      ...
      ett faktum när det finns ett tusental kurser och ett hundratal ämnen. Det
      är helt enkelt inte praktiskt möjligt att bekräfta att allt är
      ...
      eller{" "}
      <a rel="noopener noreferrer" target="_blank" href="https://m.me/kriterie">
